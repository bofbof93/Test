...
class AppDelegate: UIResponder, UIApplicationDelegate , UNUserNotificationCenterDelegate{
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        if(UserDefaults.standard.bool(forKey: "FirstRun")){
            ...
            accessCategory.addfirstCategories()
            
        }
        if(UserDefaults.standard.value(forKey: "NotifEnabled") == nil){
    ...
    func application(_ application: UIApplication, performActionFor shortcutItem: UIApplicationShortcutItem, completionHandler: @escaping (Bool) -> Void) {
        if shortcutItem.type == "addTodo" {
            ...
            let addStuffVC:UINavigationController = sb.instantiateViewController(withIdentifier: "firstNavigation") as! UINavigationController
            
            
            let root = UIApplication.shared.keyWindow?.rootViewController
            
            
            root?.present(addStuffVC, animated: false, completion: { () -> Void in
